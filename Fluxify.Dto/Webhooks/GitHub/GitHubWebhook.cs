...
public record GitHubWebhook(
    ...
    GitHubWebhookCommitsItem[] Commits,
    string? Compare,
    GitHubWebhookDiscussion? Discussion,
    bool? Forced,
    GitHubWebhookForkee? Forkee,
    GitHubWebhookCommitsItem? HeadCommit,
    GitHubWebhookIssue? Issue, 
    GitHubWebhookRequest? PullRequest,
    string? Ref,
    string? RefType,
    GitHubWebhookRelease? Release,
    GitHubWebhookForkee? Repository,
    GitHubWebhookReview? Review,
    GitHubWebhookMember Sender
);