...
public sealed partial class GatewayClient
{
    ...
    public event Func<GatewayGuildMember, Task>? GuildMemberAdd
    {
        add => InsertHandler(GatewayEvent.GuildMemberAdd, value!);
        remove => RemoveHandler(GatewayEvent.GuildMemberAdd, value!);
    }

    public event Func<GatewayGuildMember, Task>? GuildMemberUpdate
    {
    ...
    public event Func<ChannelResponse, Task>? ChannelCreate
    {
        add => InsertHandler(GatewayEvent.ChannelCreate, value!);
        remove => RemoveHandler(GatewayEvent.ChannelCreate, value!);
    }

    public event Func<ChannelResponse, Task>? ChannelUpdate
    {
    ...
    public event Func<ChannelResponse, Task>? ChannelDelete
    {
